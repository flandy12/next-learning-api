                        ...
                        <ul>
                            ...
                            <li className="mb-4">
                                <div className="grid grid-rows-3 grid-flow-col gap-4">
                                    <div className="row-span-3 ... "><a href="#"><img src="/image/qrcode.png" alt="QRCode" className="max-w-full"/></a></div>
                                    <div className="col-span-2 ... "><a href="#"><img src="/image/google-play-store.png" alt="GPlayStore" /></a></div>
                                    <div className="col-span-2  ... "><a href="#"><img src="/image/app-store.png" alt="AppStore" /></a></div>
                                </div>
                            </li>
                            <li className="text-white flex">
                                <span className="[&>svg]:h-5 [&>svg]:w-5 pr-5 cursor-pointer">
                                    <svg
